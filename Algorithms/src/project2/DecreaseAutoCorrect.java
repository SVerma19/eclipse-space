...
public class DecreaseAutoCorrect {
    /**
     * GLOBAL ATTRIBUTES
     */
    ...
    private static DecreaseSearch search = new DecreaseSearch(); // For decrease-by-a-constant-factor force search
    private static Stack<String> suggestions = new Stack<String>();

    
    public static void main(String[] args) throws Exception {
        System.out.println("\nLOADING DECREASE-BY-A-CONSTANT-FACTOR SEARCH ALGORITHM\n");
        loadWords();
        sort(words);
        startSimulation();
    }
    ...
    */
    ...
    public static void autoCorrect() {
        int result = DecreaseSearch.decreaseSearch(words, userWord);
